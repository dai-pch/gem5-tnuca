...
#undef OPCODE_NUM
#define OPCODE_NUM	machInst.opcode.num
#undef OPCODE_PREFIXA
#define OPCODE_PREFIXA	machInst.opcode.prefixA
#undef OPCODE_PREFIXB
#define OPCODE_PREFIXB	machInst.opcode.prefixB
#undef OPCODE_OP
