...
namespace X86ISAInst {
        ...
        Fault Unknown::execute(AtomicSimpleCPU *xc,
                               ...
                               Trace::InstRecord *traceData) const
    {
        ...
        Fault MovfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault MovfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Movfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault MovfpFlagsTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault MovfpFlagsTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault MovfpFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault XorfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault XorfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Xorfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SqrtfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault SqrtfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Sqrtfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault CosfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault CosfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Cosfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SinfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault SinfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Sinfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault TanfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault TanfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Tanfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault cvtf_i2dTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault cvtf_i2dTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault cvtf_i2d::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault cvtf_i2d_hiTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault cvtf_i2d_hiTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault cvtf_i2d_hi::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault cvtf_d2iTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault cvtf_d2iTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault cvtf_d2i::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault cvtint_fp80TopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault cvtint_fp80Top::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault cvtint_fp80::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault cvtfp80h_intTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault cvtfp80h_intTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault cvtfp80h_int::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault cvtfp80l_intTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault cvtfp80l_intTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault cvtfp80l_int::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault addfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault addfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault addfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault mulfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault mulfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault mulfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault divfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault divfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault divfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault subfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault subfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault subfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Yl2xFpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault Yl2xFpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Yl2xFp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault PremFpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault PremFpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault PremFp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault PremFpFlagsTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault PremFpFlagsTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FSW); };
        ...
        Fault PremFpFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FSW); };
        ...
        Fault CompfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault CompfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Compfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault absfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault absfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault absfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault absfpFlagsTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault absfpFlagsTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FSW); };
        ...
        Fault absfpFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FSW); };
        ...
        Fault chsfpTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault chsfpTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault chsfp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault chsfpFlagsTopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault chsfpFlagsTop::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FSW); };
        ...
        Fault chsfpFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FSW); };
        ...
        Fault Pop87TopTag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault Pop87Top::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TOP); };
        ...
        Fault Pop87::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
        ...
        Fault Add::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 + psrc2), dataSize);;
        ...
        Fault AddBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 + psrc2) & mask(dataSize * 8);;
        ...
        Fault AddFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 + psrc2), dataSize);;
        ...
        Fault AddFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 + psrc2) & mask(dataSize * 8);;
        ...
        Fault AddImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 + imm8), dataSize);;
        ...
        Fault AddImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 + imm8) & mask(dataSize * 8);;
        ...
        Fault AddFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 + imm8), dataSize);;
        ...
        Fault AddFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 + imm8) & mask(dataSize * 8);;
        ...
        Fault Or::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 | psrc2), dataSize);;
        ...
        Fault OrBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 | psrc2) & mask(dataSize * 8);;
        ...
        Fault OrFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 | psrc2), dataSize);;
        ...
        Fault OrFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 | psrc2) & mask(dataSize * 8);;
        ...
        Fault OrImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 | imm8), dataSize);;
        ...
        Fault OrImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 | imm8) & mask(dataSize * 8);;
        ...
        Fault OrFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 | imm8), dataSize);;
        ...
        Fault OrFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 | imm8) & mask(dataSize * 8);;
        ...
        Fault Adc::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault AdcBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault AdcFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault AdcFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault AdcImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault AdcImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault AdcFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault AdcFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Sbb::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SbbBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SbbFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SbbFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SbbImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SbbImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SbbFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SbbFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 & psrc2), dataSize);
        ...
        Fault AndBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 & psrc2) & mask(dataSize * 8);
        ...
        Fault AndFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 & psrc2), dataSize);
        ...
        Fault AndFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 & imm8), dataSize);
        ...
        Fault AndImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 & imm8) & mask(dataSize * 8);
        ...
        Fault AndFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 & imm8), dataSize);
        ...
        Fault AndFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 & imm8) & mask(dataSize * 8);
        ...
        Fault Sub::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 - psrc2), dataSize);
        ...
        Fault SubBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 - psrc2) & mask(dataSize * 8);
        ...
        Fault SubFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 - psrc2), dataSize);
        ...
        Fault SubFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 - psrc2) & mask(dataSize * 8);
        ...
        Fault SubImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 - imm8), dataSize);
        ...
        Fault SubImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 - imm8) & mask(dataSize * 8);
        ...
        Fault SubFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 - imm8), dataSize);
        ...
        Fault SubFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 ^ psrc2), dataSize);
        ...
        Fault XorBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 ^ psrc2) & mask(dataSize * 8);
        ...
        Fault XorFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 ^ psrc2), dataSize);
        ...
        Fault XorFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 ^ imm8), dataSize);
        ...
        Fault XorImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 ^ imm8) & mask(dataSize * 8);
        ...
        Fault XorFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, result = (psrc1 ^ imm8), dataSize);
        ...
        Fault XorFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = result = (psrc1 ^ imm8) & mask(dataSize * 8);
        ...
        Fault Mul1s::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault Mul1sFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault Mul1sImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mul1sFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mul1u::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault Mul1uFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault Mul1uImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mul1uFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mulel::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault MulelBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Muleh::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault MulehBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div1::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault Div1Imm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2Big::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2Flags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2FlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2Imm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2ImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2FlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Div2FlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Divq::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault DivqBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Divr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault DivrBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mov::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(SrcReg1, psrc2, dataSize);
        ...
        Fault MovFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(SrcReg1, psrc2, dataSize);
        ...
        Fault MovImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault MovFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SllBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SllFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SllFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SllImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SllFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SllFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SrlBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SrlFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SrlFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SrlImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SrlFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SrlFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SraBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SraFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SraFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SraImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SraFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SraFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Ror::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RorFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RorImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RorFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rcr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RcrFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RcrImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RcrFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rol::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RolFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RolImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RolFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rcl::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RclFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault RclImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RclFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Sld::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SldBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SldFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SldFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SldImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SldImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SldFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SldFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Srd::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SrdBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SrdFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SrdFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SrdImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SrdImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SrdFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SrdFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mdb::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DoubleBits = psrc1 ^ psrc2;;
        ...
        Fault MdbImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DoubleBits = psrc1 ^ imm8;;
        ...
        Fault Wrip::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault WripFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault WripImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault WripFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wruflags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault WruflagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wrflags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(nccFlagBits); };
        ...
        Fault WrflagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(nccFlagBits); };
        ...
        Fault Rdip::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Ruflags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rflags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Ruflag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RuflagBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rflag::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RflagBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Sext::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SextBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SextFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SextFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
uint64_t psrc2 = pick(SrcReg2, 1, dataSize);
        ...
        Fault SextImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SextImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SextFlagsImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault SextFlagsImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Zext::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, bits(psrc1, psrc2, 0), dataSize);;
        ...
        Fault ZextBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = bits(psrc1, psrc2, 0) & mask(dataSize * 8);;
        ...
        Fault ZextImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = merge(DestReg, bits(psrc1, imm8, 0), dataSize);;
        ...
        Fault ZextImmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
DestReg = bits(psrc1, imm8, 0) & mask(dataSize * 8);;
        ...
        Fault Rddr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RddrBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wrdr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(DebugDest); };
        ...
        Fault Rdcr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdcrBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wrcr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(ControlDest); };
        ...
        Fault Wrbase::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegBaseDest); };
        ...
        Fault WrbaseFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegBaseDest); };
        ...
        Fault Wrlimit::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegLimitDest); };
        ...
        Fault WrlimitFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegLimitDest); };
        ...
        Fault Wrsel::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegSelDest); };
        ...
        Fault WrselFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegSelDest); };
        ...
        Fault WrAttr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegAttrDest); };
        ...
        Fault WrAttrFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegAttrDest); };
        ...
        Fault Rdbase::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdbaseBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdbaseFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdbaseFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rdlimit::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdlimitBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdlimitFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdlimitFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdAttr::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdAttrBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdAttrFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdAttrFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rdsel::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdselBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdselFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault RdselFlagsBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rdval::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wrval::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(MiscRegDest); };
        ...
        Fault Chks::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault ChksFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wrdh::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wrtsc::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(TscOp); };
        ...
        Fault Rdtsc::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Rdm5reg::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Wrdl::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(SegAttrDest); };
        ...
        Fault Wrxftw::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault Rdxftw::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Limm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t DestReg = 0;
;
...
;
        ...
        Fault LimmBig::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t DestReg = 0;
;
        ...
        Fault Lfpimm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t FpDestReg = 0;
;
    ...
    Fault Ld::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ld::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault LdBig::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault LdBig::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldst::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldst::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault LdstBig::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault LdstBig::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldstl::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldstl::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault LdstlBig::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault LdstlBig::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldfp::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldfp::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldfp87::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Ldfp87::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault St::execute(AtomicSimpleCPU * xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault St::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault St::completeAcc(PacketPtr pkt,
            AtomicSimpleCPU * xc, Trace::InstRecord * traceData) const
    {
        ;
        ;
        ;
    ...
    Fault Stul::execute(AtomicSimpleCPU * xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Stul::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Stfp::execute(AtomicSimpleCPU * xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Stfp::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Stfp87::execute(AtomicSimpleCPU * xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Stfp87::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Cda::execute(AtomicSimpleCPU * xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Cda::initiateAcc(AtomicSimpleCPU * xc,
            Trace::InstRecord * traceData) const
    {
        Fault fault = NoFault;
...
;
    ...
    Fault Lea::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    Fault Tia::execute(AtomicSimpleCPU *xc,
          Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        Addr EA;
...
;
    ...
    ;
        ...
        Fault Mov2int::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mov2fp::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Movsign::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Maskmov::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault shuffle::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Unpack::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Pack::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mxor::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mor::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mand::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mandn::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mminf::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mmaxf::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mmini::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mmaxi::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Msqrt::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Maddf::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Msubf::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mmulf::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mdivf::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Maddi::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Msubi::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mmuli::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mavg::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Msad::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Msrl::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault MsrlImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Msra::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault MsraImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Msll::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault MsllImm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Cvtf2i::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Cvti2f::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Cvtf2f::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mcmpi2r::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mcmpf2r::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Mcmpf2rf::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
;
        ...
        Fault Emms::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
if (traceData) { traceData->setData(FTW); };
        ...
        Fault MicroBranchFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t nuIP;
uint64_t ccFlagBits = 0;
...
;
        ...
        Fault MicroBranch::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t nuIP;
TheISA::PCState __parserAutoPCState;
...
;
        ...
        Fault EretFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t ccFlagBits = 0;
uint64_t cfofBits = 0;
...
;
        ...
        Fault Eret::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            ;
            ;
    ...
    Fault
    MicroHalt::execute(AtomicSimpleCPU *xc,
            Trace::InstRecord * traceData) const
    {
        xc->tcBase()->suspend();
        return NoFault;
        ...
        Fault MicroFaultFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t ccFlagBits = 0;
uint64_t cfofBits = 0;
...
;
        ...
        Fault MicroFault::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            ;
            ;
        ...
        Fault Mfence::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
        ...
        Fault
        MicroPanicFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t ccFlagBits = 0;
uint64_t cfofBits = 0;
...
ezfBit = xc->readCCRegOperand(this, 4);
        ...
        Fault
        MicroPanic::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
        ...
        Fault
        MicroFatalFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t ccFlagBits = 0;
uint64_t cfofBits = 0;
...
ezfBit = xc->readCCRegOperand(this, 4);
        ...
        Fault
        MicroFatal::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
        ...
        Fault
        MicroWarnFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t ccFlagBits = 0;
uint64_t cfofBits = 0;
...
ezfBit = xc->readCCRegOperand(this, 4);
        ...
        Fault
        MicroWarn::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
        ...
        Fault
        MicroWarn_onceFlags::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            uint64_t ccFlagBits = 0;
uint64_t cfofBits = 0;
...
ezfBit = xc->readCCRegOperand(this, 4);
        ...
        Fault
        MicroWarn_once::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
...
// NopInst::NOP(([], {}))
    ...
    Fault NOP::execute(AtomicSimpleCPU *xc,
            Trace::InstRecord *traceData) const
    {
        return NoFault;
    }
...
// SyscallInst::int80((['xc->syscall(Rax)', 'IsSyscall', 'IsNonSpeculative', 'IsSerializeAfter'], {}))
    ...
    Fault Int80::execute(AtomicSimpleCPU *xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        uint64_t Rax = 0;
...
// BasicOperate::m5arm(['\n                            PseudoInst::arm(xc->tcBase());\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5arm::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5quiesce(['\n                            PseudoInst::quiesce(xc->tcBase());\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5quiesce::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5quiesceNs(['\n                            PseudoInst::quiesceNs(xc->tcBase(), Rdi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5quiesceNs::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5quiesceCycle(['\n                            PseudoInst::quiesceCycles(xc->tcBase(), Rdi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5quiesceCycle::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5quiesceTime(['\n                            Rax = PseudoInst::quiesceTime(xc->tcBase());\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5quiesceTime::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5rpns(['\n                            Rax = PseudoInst::rpns(xc->tcBase());\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5rpns::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5fail(['\n                            PseudoInst::m5fail(xc->tcBase(), Rdi, Rsi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5fail::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5initparam(['\n                            Rax = PseudoInst::initParam(xc->tcBase());\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5initparam::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5loadsymbol(['\n                            PseudoInst::loadsymbol(xc->tcBase());\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5loadsymbol::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5resetstats(['\n                            PseudoInst::resetstats(xc->tcBase(), Rdi, Rsi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5resetstats::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5dumpstats(['\n                            PseudoInst::dumpstats(xc->tcBase(), Rdi, Rsi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5dumpstats::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5dumpresetstats(['\n                            PseudoInst::dumpresetstats(xc->tcBase(), Rdi, Rsi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5dumpresetstats::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5debugbreak(['\n                            PseudoInst::debugbreak(xc->tcBase());\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5debugbreak::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5reserved1(['\n                            warn("M5 reserved opcode 1 ignored.\\n");\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5reserved1::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5_work_begin(['\n                            PseudoInst::workbegin(xc->tcBase(), Rdi, Rsi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5_work_begin::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::m5_work_end(['\n                            PseudoInst::workend(xc->tcBase(), Rdi, Rsi);\n                        ', 'IsNonSpeculative'],{})
        ...
        Fault M5_work_end::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// SyscallInst::syscall((['xc->syscall(Rax)', 'IsSyscall', 'IsNonSpeculative', 'IsSerializeAfter'], {}))
    ...
    Fault Syscall::execute(AtomicSimpleCPU *xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        uint64_t Rax = 0;
...
// SyscallInst::sysenter((['xc->syscall(Rax)', 'IsSyscall', 'IsNonSpeculative', 'IsSerializeAfter'], {}))
    ...
    Fault Sysenter::execute(AtomicSimpleCPU *xc,
            Trace::InstRecord *traceData) const
    {
        Fault fault = NoFault;
        uint64_t Rax = 0;
...
// CPUIDInst::CPUID((['\n                    CpuidResult result;\n                    bool success = doCpuid(xc->tcBase(), bits(Rax, 31, 0),\n                        bits(Rcx, 31, 0), result);\n                    if (success) {\n                        Rax = result.rax;\n                        Rbx = result.rbx;\n                        Rcx = result.rcx;\n                        Rdx = result.rdx;\n                    } else {\n                        Rax = Rax;\n                        Rbx = Rbx;\n                        Rcx = Rcx;\n                        Rdx = Rdx;\n                    }\n                    '], {}))
    ...
    Fault CPUID::execute(AtomicSimpleCPU *xc,
            Trace::InstRecord *traceData) const
    {
...
// BasicOperate::LFENCE((['/*Nothing*/', 'IsReadBarrier'], {}))
        ...
        Fault LFENCE::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
...
// BasicOperate::SFENCE((['/*Nothing*/', 'IsWriteBarrier'], {}))
        ...
        Fault SFENCE::execute(AtomicSimpleCPU *xc,
                Trace::InstRecord *traceData) const
        {
            Fault fault = NoFault;
